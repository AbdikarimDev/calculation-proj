<template>
  <div class="flex min-h-screen w-full">
    ...
    <div class="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-600 to-blue-800 text-white flex-col justify-between p-12">
      <!-- Top content -->
      <div>
        <h1 class="text-4xl font-bold mb-4">NovaPOS</h1>
        <p class="text-blue-100 text-lg">Complete Point of Sale Solution</p>
      </div>
      ...
      <div class="space-y-8">
        <div class="flex items-center space-x-4">
          ...
          <div>
            <h3 class="font-semibold text-lg">Fast Processing</h3>
            <p class="text-blue-100 text-sm">Quick checkout and inventory management</p>
          </div>
        </div>
        ...
        <div class="flex items-center space-x-4">
          ...
          <div>
            ...
            <p class="text-blue-100 text-sm">Your data is always protected</p>
          </div>
        </div>
        ...
        <div class="flex items-center space-x-4">
          ...
          <div>
            <h3 class="font-semibold text-lg">Real-time Reports</h3>
            <p class="text-blue-100 text-sm">Track sales and inventory instantly</p>
          </div>
        </div>
      </div>
      ...
      <!-- Bottom content -->
      <div>
        <p class="text-blue-200 text-sm">© 2024 NovaPOS. All rights reserved.</p>
      </div>
    </div>
    ...
    <div class="w-full lg:w-1/2 flex items-center justify-center p-8 bg-gray-50">
      <div class="w-full max-w-md">
        ...
        <div class="lg:hidden text-center mb-8">
          <h1 class="text-3xl font-bold text-blue-600">NovaPOS</h1>
        ...
        <div class="flex gap-4 mb-8 border-b border-gray-200">
          <button 
            ...
            :class="[
              'pb-3 px-4 font-medium transition-colors duration-200',
              activeTab === 'login' 
...
const handleSignup = async () => {
  ...
  try {
    ...
    if (error.code === 'auth/email-already-in-use') {
      message.value = 'An account already exists with this email'
